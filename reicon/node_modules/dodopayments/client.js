...
const blocklist_1 = require("./resources/blocklist/blocklist.js");
const credit_entitlements_1 = require("./resources/credit-entitlements/credit-entitlements.js");
const customers_1 = require("./resources/customers/customers.js");
const entitlements_1 = require("./resources/entitlements/entitlements.js");
const invoices_1 = require("./resources/invoices/invoices.js");
const payouts_1 = require("./resources/payouts/payouts.js");
const product_collections_1 = require("./resources/product-collections/product-collections.js");
...
class DodoPayments {
    ...
    constructor({ baseURL = (0, env_1.readEnv)('DODO_PAYMENTS_BASE_URL'), bearerToken = (0, env_1.readEnv)('DODO_PAYMENTS_API_KEY'), webhookKey = (0, env_1.readEnv)('DODO_PAYMENTS_WEBHOOK_KEY') ?? null, ...opts } = {}) {
        ...
        this.blocklist = new API.Blocklist(this);
        ...
        const customHeadersEnv = (0, env_1.readEnv)('DODO_PAYMENTS_CUSTOM_HEADERS');
        if (customHeadersEnv) {
            const parsed = {};
...
DodoPayments.Blocklist = blocklist_1.Blocklist;
...
DodoPayments.CreditEntitlements = credit_entitlements_1.CreditEntitlements;
DodoPayments.Entitlements = entitlements_1.Entitlements;
DodoPayments.ProductCollections = product_collections_1.ProductCollections;
