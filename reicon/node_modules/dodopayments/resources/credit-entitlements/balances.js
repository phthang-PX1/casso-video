...
class Balances extends resource_1.APIResource {
    ...
    listGrants(customerID, params, options) {
        ...
        return this._client.getAPIList((0, path_1.path) `/credit-entitlements/${credit_entitlement_id}/balances/${customerID}/grants`, (pagination_1.DefaultPageNumberPagination), { query, ...options });
    }
    /**
