...
export declare class Subscriptions extends APIResource {
     ...
     * ```
     */
    changePlan(subscriptionID: string, body: SubscriptionChangePlanParams, options?: RequestOptions): APIPromise<SubscriptionChangePlanResponse>;
    /**
...
export type SubscriptionStatus = 'pending' | 'active' | 'on_hold' | 'paused' | 'cancelled' | 'failed' | 'expired' | 'past_due';
/**
 * Unit of a duration count (e.g. license-key validity period).
 */
