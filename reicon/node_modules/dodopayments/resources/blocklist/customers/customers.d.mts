...
import * as NotesAPI from "./notes.mjs";
import { BlockedCustomerNote, NoteCreateParams, NoteRequest, NoteUpdateParams, Notes } from "./notes.mjs";
...
export declare class Customers extends APIResource {
    ...
    list(query?: CustomerListParams | null | undefined, options?: RequestOptions): PagePromise<BlockedCustomersDefaultPageNumberPagination, BlockedCustomer>;
 ...
 * dashboard actor. The other values name the screen the merchant used.
 */
export type BlockedCustomerSource = 'blocklist_page' | 'customer_page' | 'payment_page' | 'dispute_page' | 'api';
export type CreateBlockedCustomerRequest = CreateBlockedCustomerRequest.BlocklistCustomersBlockByCustomerID | CreateBlockedCustomerRequest.BlocklistCustomersBlockByEmail;
export declare namespace CreateBlockedCustomerRequest {
    interface BlocklistCustomersBlockByCustomerID extends CustomersAPI.BlockByCustomerID {
        /**
    ...
    interface BlocklistCustomersBlockByEmail extends CustomersAPI.BlockByEmail {
        /**
         * Why the merchant blocked this customer. The entry page shows it.
         */
        reason?: string | null;
...
export type CustomerCreateParams = CustomerCreateParams.BlocklistCustomersBlockByCustomerID | CustomerCreateParams.BlocklistCustomersBlockByEmail;
export declare namespace CustomerCreateParams {
    interface BlocklistCustomersBlockByCustomerID {
        /**
         * Customer to block. The block still applies to that customer's email.
         */
        customer_id: string;
    ...
    interface BlocklistCustomersBlockByEmail {
        /**
         * Email to block. It must belong to an existing customer of this business.
         */
        email: string;
...
export declare namespace Customers {
    export { type BlockByCustomerID as BlockByCustomerID, type BlockByEmail as BlockByEmail, type BlockIdentifier as BlockIdentifier, type BlockedCustomer as BlockedCustomer, type BlockedCustomerSource as BlockedCustomerSource, type CreateBlockedCustomerRequest as CreateBlockedCustomerRequest, type BlockedCustomersDefaultPageNumberPagination as BlockedCustomersDefaultPageNumberPagination, type CustomerListParams as CustomerListParams, type CustomerCreateParams as CustomerCreateParams, };
    export { Notes as Notes, type BlockedCustomerNote as BlockedCustomerNote, type NoteRequest as NoteRequest, type NoteCreateParams as NoteCreateParams, type NoteUpdateParams as NoteUpdateParams, };
}
