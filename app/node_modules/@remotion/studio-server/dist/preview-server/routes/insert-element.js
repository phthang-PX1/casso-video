...
const insertElementHandler = ({ input: { compositionFile, compositionId, element, installationName, expectedFileState, from, position, overwriteExisting, }, entryPoint, remotionRoot, logLevel, }) => (0, source_file_write_queue_1.withSourceFileWriteQueue)(async () => {
    var _a;
    var _b;
    try {
        ...
        const inserted = await (0, resolve_composition_component_1.insertJsxElementIntoComposition)({
            ...
            element: {
                ...
                props: [
                    ...Object.entries((_b = element.initialProps) !== null && _b !== void 0 ? _b : {}).map(([name, value]) => ({ name, value })),
