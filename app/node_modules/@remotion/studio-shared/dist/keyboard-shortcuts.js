...
exports.validateStudioKeyboardShortcuts = exports.studioKeyboardShortcutActions = void 0;
exports.studioKeyboardShortcutActions = [
    'playPause',
    'toggleMute',
    'toggleLoop',
    'jumpToBeginning',
...
const actionSet = new Set(exports.studioKeyboardShortcutActions);
const validateShortcut = ({ action, shortcut, }) => {
...
const validateStudioKeyboardShortcuts = (value) => {
...
exports.validateStudioKeyboardShortcuts = validateStudioKeyboardShortcuts;
