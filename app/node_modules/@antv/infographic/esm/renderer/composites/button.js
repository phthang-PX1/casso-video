import { createElement, getAttributes, parseSVG, setAttributes, setElementRole, } from '../../utils/index.js';
const ADD_ICON_ID = 'btn-add-icon';
const REMOVE_ICON_ID = 'btn-remove-icon';
export function renderButtonsGroup(svg, group) {
...
function renderButtonIcon(node, name) {
    const { id, x = 0, y = 0, width = 0, height = 0, } = getAttributes(node, ['id', 'x', 'y', 'width', 'height']);
