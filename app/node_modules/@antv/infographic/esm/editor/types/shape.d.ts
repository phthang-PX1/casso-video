...
export interface GeometryProps extends BaseShapeProps {
    type: ShapeTypeEnum.Rectangle | ShapeTypeEnum.Circle | ShapeTypeEnum.Ellipse | ShapeTypeEnum.Line | ShapeTypeEnum.Polyline | ShapeTypeEnum.Polygon | ShapeTypeEnum.Path | ShapeTypeEnum.Image;
}
