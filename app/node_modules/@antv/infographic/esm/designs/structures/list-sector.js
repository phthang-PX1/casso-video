...
export const ListSector = (props) => {
    ...
    `.trim();
        ...
        sectorElements.push(_jsx(Path, { id: "shape-sector", d: arcPath, fill: color, width: outerRadius * 2 + 200, height: outerRadius * 2 + 200, "data-element-type": "shape" }));
    ...
    if (items.length > 0) {
        ...
        const btnAddY = centerY +
            ...
            btnBounds.height / 2;
        btnElements.push(_jsx(BtnAdd, { indexes: [0], x: btnAddX, y: btnAddY }));
    }
