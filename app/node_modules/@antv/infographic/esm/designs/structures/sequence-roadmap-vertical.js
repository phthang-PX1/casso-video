...
function buildDecorations({ direction, x, y, color, elements }) {
    const isLeft = direction === 'left';
    elements.push(_jsx(Triangle, { x: isLeft ? x.x6 + 10 : x.x1 - 20, y: y.y3 - 5, width: 10, height: 8, rotation: isLeft ? 90 : -90, colorPrimary: color, "data-element-type": "shape" }));
}
export const SequenceRoadmapVertical = (props) => {
    ...
    return (_jsxs(FlexLayout, { id: "infographic-container", flexDirection: "column", justifyContent: "center", alignItems: "center", children: [titleContent, _jsxs(Group, { width: totalWidth, height: itemBounds.height <= outerRadius * 2
                    ? roadmapHeight
                    : roadmapHeight + itemBounds.height - outerRadius * 2, children: [_jsx(Path, { width: rowWidth, height: roadmapHeight, d: pathArr.join(' '), fill: colorDefault, stroke: colorDefault, strokeWidth: "4", strokeLinecap: "round", strokeLinejoin: "round", "data-element-type": "shape" }), _jsx(Path, { d: midPath.join(' '), stroke: "white", fill: "none", strokeWidth: "3", strokeDasharray: "8 8", strokeLinecap: "round", strokeLinejoin: "round", "data-element-type": "shape" }), _jsxs(_Fragment, { children: [itemIcons, seriesNumber, itemElements, decorationElements] })] })] }));
};
