...
exports.ResizeElement = void 0;
const utils_1 = require("../../utils");
const commands_1 = require("../commands");
const utils_2 = require("../utils");
const base_1 = require("./base");
class ResizeElement extends base_1.Plugin {
    constructor() {
        super(...arguments);
        ...
        this.handleSelectionChange = ({ next }) => {
            ...
            if (only && (0, utils_1.isEditableText)(only)) {
                this.target = only;
                this.updateHandles();
            }
            else {
        ...
        this.handlePointerUp = (event) => {
            ...
            if (changed && this.target && finalRect && original) {
                this.commander.execute(new commands_1.UpdateElementCommand(this.target, { attributes: finalRect }, { attributes: original }));
                this.lastViewportRect = this.getViewportRect(this.target);
                this.updateHandles(this.lastViewportRect);
                this.emitSelectionGeometryChange();
            }
    ...
    ensureContainer() {
        ...
        const container = (0, utils_1.createElement)('g', {
            'pointer-events': 'none',
        });
        this.overlay = (0, utils_1.createElement)('rect', {
            fill: 'rgba(51, 132, 245, 0.06)',
            stroke: 'none',
            'pointer-events': 'none',
        });
        const outline = (0, utils_1.createElement)('rect', {
            fill: 'none',
            stroke: '#3384F5',
            'stroke-width': 1,
        ...
        handlePositions.forEach((pos, index) => {
            ...
            const handle = isEdge
                ? (0, utils_1.createElement)('line', {
                    stroke: 'transparent',
                    'stroke-width': ResizeElement.LINE_STROKE_WIDTH,
                })
                : (0, utils_1.createElement)('circle', {
    ...
    applyRect(target, rect) {
        (0, utils_1.setAttributes)(target, {
            x: rect.x,
            y: rect.y,
            width: rect.width,
            height: rect.height,
    ...
    getViewportRect(element) {
        const { x, y, width, height } = (0, utils_2.getElementViewportBounds)(this.editor.getDocument(), element);
    ...
    getCurrentAttributes(element) {
        const attrs = (0, utils_1.getAttributes)(element, ['x', 'y', 'width', 'height'], false);
