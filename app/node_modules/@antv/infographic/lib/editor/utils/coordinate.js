...
exports.getInverseScreenCTM = getInverseScreenCTM;
exports.viewportToClient = viewportToClient;
exports.clientToViewport = clientToViewport;
exports.getElementViewportBounds = getElementViewportBounds;
...
function viewportToClient(svg, x, y) {
    const svgPoint = new DOMPoint(x, y).matrixTransform(getScreenCTM(svg));
    const containerBounds = svg.getBoundingClientRect();
    return new DOMPoint(svgPoint.x - containerBounds.left, svgPoint.y - containerBounds.top);
}
function clientToViewport(svg, x, y) {
