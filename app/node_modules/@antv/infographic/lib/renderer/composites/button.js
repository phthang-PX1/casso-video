...
function defineButtonIcon(svg) {
    ...
    (0, utils_1.setElementRole)(defs, btnIconDefRole);
    const addIconSymbol = (0, utils_1.parseSVG)(`<symbol class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" width="200" height="200">
  <path
    ...
    const removeIconSymbol = (0, utils_1.parseSVG)(`<symbol viewBox="0 0 1025 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" width="200" height="200">
...
function renderButtonIcon(node, name) {
    const { id, x = 0, y = 0, width = 0, height = 0, } = (0, utils_1.getAttributes)(node, ['id', 'x', 'y', 'width', 'height']);
    const group = (0, utils_1.createElement)('g', {
        id,
        class: 'btn-group',
    ...
    const bkg = (0, utils_1.createElement)('circle', {
        cx: r,
        cy: r,
        r,
        fill: '#fff',
    ...
    const icon = (0, utils_1.createElement)('use', {
        href: `#${name}`,
        width,
        height,
    });
