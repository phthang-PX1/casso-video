...
export type ItemDatum = ListDatum | SequenceDatum | HierarchyDatum | CompareDatum | RelationNodeDatum | StatisticsDatum;
...
export type Data = ListData | SequenceData | HierarchyData | CompareData | RelationData | StatisticsData;
