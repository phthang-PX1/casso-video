...
const ListSector = (props) => {
    ...
    const totalGapAngle = items.length > 0
    ...
    `.trim();
        ...
        sectorElements.push((0, jsx_runtime_1.jsx)(jsx_1.Path, { id: "shape-sector", d: arcPath, fill: color, width: outerRadius * 2 + 200, height: outerRadius * 2 + 200, "data-element-type": "shape" }));
    ...
    if (items.length > 0) {
        ...
        const btnAddY = centerY +
            ...
            btnBounds.height / 2;
        btnElements.push((0, jsx_runtime_1.jsx)(components_1.BtnAdd, { indexes: [0], x: btnAddX, y: btnAddY }));
    }
