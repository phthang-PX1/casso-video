...
const HierarchyTree = (props) => {
    ...
    const renderNode = (node, levelBounds, btnBounds, offsets, gradientDefs, allNodes) => {
        ...
        const nodeColor = (0, utils_1.getPaletteColor)(options, colorIndexes);
        const nodeThemeColors = (0, utils_1.getThemeColors)({
            colorPrimary: nodeColor,
        }, options);
        // 节点本体
        elements.items.push((0, jsx_runtime_1.jsx)(NodeComponent, { indexes: indexes, datum: nodeData, data: data, x: nodeX, y: nodeY, positionH: "center", themeColors: nodeThemeColors }));
        // 删除和添加按钮
        elements.btns.push((0, jsx_runtime_1.jsx)(components_1.BtnRemove, { indexes: indexes, x: nodeX + (bounds.width - btnBounds.width) / 2, y: nodeY + bounds.height + 5 }), (0, jsx_runtime_1.jsx)(components_1.BtnAdd, { indexes: [...indexes, 0], x: nodeX + (bounds.width - btnBounds.width) / 2, y: nodeY + bounds.height + btnBounds.height + 10 }));
        // 父子连线
        if (parent) {
            ...
            if (edgeColorMode === 'gradient') {
                ...
                const parentColor = (0, utils_1.getPaletteColor)(options, parentColorIndexes);
                const childColor = (0, utils_1.getPaletteColor)(options, childColorIndexes);
                const gradientId = `gradient-${parent.data._originalIndex.join('-')}-${indexes.join('-')}`;
                gradientDefs.push((0, jsx_runtime_1.jsxs)("linearGradient", { id: gradientId, x1: parentX, y1: parentY, x2: childX, y2: childY, gradientUnits: "userSpaceOnUse", children: [(0, jsx_runtime_1.jsx)("stop", { offset: "0%", stopColor: parentColor }), (0, jsx_runtime_1.jsx)("stop", { offset: "100%", stopColor: childColor })] }));
                strokeColor = `url(#${gradientId})`;
            }
            // 确定虚线样式
            const dashArray = edgeStyle === 'dashed' ? edgeDashPattern : '';
            // 绘制连接线
            elements.deco.push((0, jsx_runtime_1.jsx)(jsx_1.Path, { d: pathD, stroke: strokeColor, strokeWidth: edgeWidth, strokeDasharray: dashArray, fill: "none" }));
            // 添加箭头
            if (edgeMarker === 'arrow') {
    ...
    // 空状态处理
    if (!items.length) {
        return ((0, jsx_runtime_1.jsxs)(layouts_1.FlexLayout, { id: "infographic-container", flexDirection: "column", justifyContent: "center", alignItems: "center", children: [titleContent, (0, jsx_runtime_1.jsx)(jsx_1.Group, { children: (0, jsx_runtime_1.jsx)(components_1.BtnsGroup, { children: (0, jsx_runtime_1.jsx)(components_1.BtnAdd, { indexes: [0], x: -btnBounds.width / 2, y: -btnBounds.height / 2 }) }) })] }));
    }
    // 构建和布局
    ...
    return ((0, jsx_runtime_1.jsxs)(layouts_1.FlexLayout, { id: "infographic-container", flexDirection: "column", justifyContent: "center", alignItems: "center", children: [titleContent, (0, jsx_runtime_1.jsxs)(jsx_1.Group, { children: [gradientDefs.length > 0 && (0, jsx_runtime_1.jsx)(jsx_1.Defs, { children: gradientDefs }), (0, jsx_runtime_1.jsx)(components_1.ShapesGroup, { children: decoElements }), (0, jsx_runtime_1.jsx)(components_1.ItemsGroup, { children: itemElements }), (0, jsx_runtime_1.jsx)(components_1.BtnsGroup, { children: btnElements })] })] }));
};
exports.HierarchyTree = HierarchyTree;
(0, registry_1.registerStructure)('hierarchy-tree', {
    component: exports.HierarchyTree,
