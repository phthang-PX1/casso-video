...
const SequenceZigzagSteps = (props) => {
    ...
    if (items.length === 0) {
        ...
        return ((0, jsx_runtime_1.jsxs)(layouts_1.FlexLayout, { id: "infographic-container", flexDirection: "column", justifyContent: "center", alignItems: "center", children: [(0, jsx_runtime_1.jsx)(jsx_1.Defs, { children: GlowFilter }), titleContent, (0, jsx_runtime_1.jsx)(jsx_1.Group, { children: (0, jsx_runtime_1.jsx)(components_1.BtnsGroup, { children: btnAddElement }) })] }));
    }
    ...
    items.forEach((item, index) => {
        ...
        decoElements.push((0, jsx_runtime_1.jsxs)(components_1.ShapesGroup, { x: decoX, y: decoY, width: 140, height: 110, children: [(0, jsx_runtime_1.jsx)(jsx_1.Ellipse, { x: glowX, y: glowY, width: GLOW_W, height: GLOW_H, fill: currentColor || colorPrimary, filter: "url(#sequence-zigzag-glow-filter)", opacity: GLOW_OPACITY }), (0, jsx_runtime_1.jsx)(jsx_1.Path, { d: DECO_PATH_1, fill: currentColor || colorPrimary }), (0, jsx_runtime_1.jsx)(jsx_1.Path, { d: DECO_PATH_2, fill: '#fff' }), (0, jsx_runtime_1.jsx)(jsx_1.Path, { d: DECO_PATH_2, fill: colorPrimaryBg || colorPrimaryBg })] }));
        // Icon 元素
        if (item.icon) {
